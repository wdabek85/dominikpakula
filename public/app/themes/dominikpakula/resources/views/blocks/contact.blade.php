  ...
  <div class="flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-20">
      ...
      <div class="flex flex-col gap-6 text-[#01000d]">
        ...
        <div class="flex flex-col gap-2">
          <div class="flex items-center gap-1">
            <svg class="size-6 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
            </svg>
            <span class="font-poppins text-base leading-5">E-mail:</span>
          </div>
          <a href="mailto:kontakt@akorn.pl" class="font-poppins text-sm leading-4 hover:underline">kontakt@akorn.pl</a>
        </div>
        ...
        <div class="flex flex-col gap-2">
          ...
          <a href="tel:+48884826068" class="font-poppins text-sm leading-4 hover:underline">+48 884 826 068</a>
        </div>
        ...
        <div class="flex flex-col gap-2">
          ...
          <p class="font-poppins text-sm leading-4">
            Micigózd ul. Częstochowska 36<br>
            26-065
          </p>
        </div>
    ...
    <div class="flex flex-col gap-4 flex-1">
      <form class="flex flex-col gap-2">
        ...
        <div class="flex flex-col gap-2">
          ...
          <div class="flex items-center gap-2 border border-[#e2e2e2] px-4 py-3 focus-within:border-primary transition-colors">
            <svg class="size-6 shrink-0 text-[#8b8b8b]" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
            </svg>
            <input
              type="email"
      ...
      <p class="font-poppins text-xs leading-[14px] text-[#01000d]">
        Zapisując się, akceptujesz nasze <a href="#" class="underline">warunki korzystania z usługi</a>. Możesz wypisać się w każdej chwili. Zero spamu, tylko konkret.
      </p>
      ...
      <button
        type="submit"
        form="contact-form"
        class="w-full bg-primary border border-white px-6 py-4 rounded-sm font-poppins font-medium text-base leading-[26px] text-white transition-colors hover:bg-primary/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary"
      >
        Wyślij
      </button>
    </div>
