{{-- Share: Skopiuj link + Messenger/WhatsApp/Facebook/Email (współdzieli blog-share.js) --}}
<div class="flex flex-col gap-4">
  ...
  <p class="font-poppins text-sm text-black/80 leading-relaxed">
    Ten poradnik Ci pomógł? Podrzuć go komuś, komu też może się przydać.
  </p>
  ...
  <button
    ...
    aria-label="Skopiuj link do poradnika"
  >
  ...
  <div class="flex items-center justify-center gap-2">
    <a href="{{ $shareLinks['messenger'] }}" target="_blank" rel="noopener"
      ...
      aria-label="Wyślij na Messengerze" title="Wyślij na Messengerze">
      <x-icons.messenger class="size-5" />
    </a>
    <a href="{{ $shareLinks['whatsapp'] }}" target="_blank" rel="noopener"
      class="size-10 rounded-full bg-black/5 flex items-center justify-center text-black/70 hover:bg-primary hover:text-white transition-colors"
      aria-label="Wyślij na WhatsApp" title="Wyślij na WhatsApp">
      <x-icons.whatsapp class="size-5" />
    </a>
    <a href="{{ $shareLinks['facebook'] }}" target="_blank" rel="noopener"
      class="size-10 rounded-full bg-black/5 flex items-center justify-center text-black/70 hover:bg-primary hover:text-white transition-colors"
      aria-label="Udostępnij na Facebooku" title="Udostępnij na Facebooku">
      <x-icons.facebook class="size-5" />
    </a>
    <a href="{{ $shareLinks['email'] }}"
      class="size-10 rounded-full bg-black/5 flex items-center justify-center text-black/70 hover:bg-primary hover:text-white transition-colors"
      aria-label="E-mail do przyjaciela" title="E-mail do przyjaciela">
